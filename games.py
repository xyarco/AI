...
def minimax_decision(state, game):
    ...
    print('Nodes expanded for minimax: '+str(count))
    return action
...
def alphabeta_search(state, game):
    ...
    action, state = argmax(game.successors(state),
                           lambda ((a, s)): min_value(s, -1, 1))
    print('Nodes expanded for alpha-beta pruning: '+str(number))
    return action
